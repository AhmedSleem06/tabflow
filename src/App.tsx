...
function PricingCardBasicPlan() {
  ...
  return (
    <div className="flex flex-col w-[22rem] px-6 p-4 border rounded-xl shadow bg-white  ">
      ...
      <section className="flex mt-2 gap-3 text-3xl font-bold">
        <h2 className="line-through text-gray-400">$20</h2>

        <h2 className="text-green-600">$15</h2>
      </section>
      <section className="flex-col flex gap-3 mt-5">
      ...
      <Button size={"lg"} className="rounded-full cursor-pointer mt-6">
        Pre-Order Now
      </Button>
    </div>
  );
  ...
  return (
    <div className="flex flex-col w-[22rem] px-6 p-4 border border-green-600 rounded-xl shadow bg-white  ">
      <section className="flex justify-between items-center">
        <h1 className="font-bold text-xl">Advanced AI Plan</h1>
  ...
  return (
    <div className="my-20   ">
      <section className="container mx-auto flex flex-col items-center  ">
        <h1 className="font-bold text-4xl">Simple & Affordable</h1>
        <h4 className="mt-4 text-muted-foreground font-medium text-center">
          One-time purchase, lifetime updates
        </h4>
        <div className="flex mt-8 gap-10 items-start">
...
const CountdownTimer = () => {
  ...
  return (
    <div className="flex space-x-4 text-xl font-semibold items-center justify-center">
      <div className="w-fit bg-white py-2 px-4 text-green-600 rounded-lg">
...
function FAQSection() {
  ...
  return (
    <div className="flex flex-col items-center  space-y-8 py-12">
      <h2 className="text-4xl font-bold">Got Questions? We've Got Answers!</h2>
      ...
      <div className="w-full bg-green-600 text-white text-center py-14  mt-10">
        ...
        <Button
          size={"xl"}
          className="mt-8 rounded-full cursor-pointer bg-white text-green-600 hover:bg-gray-100"
        >
    ...
    <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-6">
      <div>
        <section className="flex gap-2 items-center">
          ...
          <h3 className="font-bold text-lg">TabFlow</h3>
        </section>
      ...
      <div>
        ...
        <p className="text-sm mt-2 space-y-2 flex items-center">
...
function StepsToInstallSection() {
  return (
    <div className="my-26 py-8 bg-white">
...
function WhyChooseUs() {
  return (
    <div className="my-20  bg-white py-6 ">
      <section className="container mx-auto flex flex-col items-center  ">
        <h1 className="font-bold text-4xl">Why Choose TabFlow?</h1>
        <FeatureSection />
      </section>
    </div>
  );
...
function ProblemSection() {
  ...
  return (
    <div className="container mx-auto mt-10  h-[60vh] justify-center flex flex-col items-center">
...
function FeatureSection() {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-y-8 gap-x-16 mx-auto  my-6 mt-10 ">
  ...
  return (
    <div className="container  mx-auto justify-between items-center  flex   ">
      <section className="  flex flex-col">
        ...
        <h4 className="mt-4 text-muted-foreground font-medium">
      ...
      <img className={` h-[580px] object-cover`} src="heroImage.png" />
    </div>
  );
}
  ...
  return (
    <div className=" border-b-1 pt-4 pb-4 ">
      <div className="flex justify-between items-center container mx-auto ">
        ...
        <Button className="rounded-full cursor-pointer">Pre-Order Now</Button>
      </div>
    </div>
  );
}
...
function Logo() {
  return (
    <a href="/" className="flex cursor-pointer w-fit items-center  gap-1 ">
      <img src="./icon.png" alt="Logo" className="w-11 h-11" />
